...
namespace OmnifariusMod.Projectiles
{
    public class flailProjectile : ModProjectile
    {
        ...
        {
            projectile.name = "Cool Flail Ball";
            projectile.width = 28;
        ...
        {
            // So set the correct path here to load the chain texture. 'OmnifariusMod' is of course the name of your mod.
            // Then into the Projectiles folder and take the texture that is called 'CustomFlailBall_Chain'.
            Texture2D texture = ModLoader.GetTexture("OmnifariusMod/Projectiles/flail_Chain");
