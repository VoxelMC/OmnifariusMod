...
{
    public class InfernoChestTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            AddMapEntry(new Color(200, 200, 200), "Inferno Chest", MapChestName);
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 32, mod.ItemType("InfernoChest"));   //here put your Chest Item name
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.showItemIcon2 = mod.ItemType("InfernoChest");         //here put your Chest Item name
